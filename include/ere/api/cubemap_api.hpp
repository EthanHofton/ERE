...
public:
    ...
    static ref<cubemap_api> create_cubemap_api(const std::string paths[6]);
    static ref<cubemap_api> create_cubemap_api(const format& t_format, uint32_t width, uint32_t height);
    static ref<cubemap_api> create_cubemap_api(unsigned char* data[6], const format& format, uint32_t width, uint32_t height);
